        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Challenges_Posts_PostId",
                        column: x => x.PostId,
                        principalSchema: "tiktok_v1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EffectStickers_Posts_PostId",
                        column: x => x.PostId,
                        principalSchema: "tiktok_v1",
                        principalTable: "Posts",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Challenges_PostId",
                schema: "tiktok_v1",
                table: "Challenges",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_EffectStickers_PostId",
                schema: "tiktok_v1",
                table: "EffectStickers",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_Music_PostId",
                schema: "tiktok_v1",
                table: "Music",
                column: "PostId");
